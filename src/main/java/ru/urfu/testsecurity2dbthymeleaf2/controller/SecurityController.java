package ru.urfu.testsecurity2dbthymeleaf2.controller;
...
import ru.urfu.testsecurity2dbthymeleaf2.service.UserService;
    ...
    public String registration(@Valid @ModelAttribute("user") UserDto userDto,
        ...
        if (existingUser != null && existingUser.getEmail() != null && !existingUser.getEmail().isEmpty()) {
            result.rejectValue("email", null,
                    "НА этот адрес электронной почты уже зарегистрирована уччетная запись");
        }
